...
public class LoginServlet extends ChatServlet{
    ...
    // Пользователю необходимо ввести имя. Показать форму, Задать кодировку HTTP-ответа
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Задать кодировку HTTP-запроса - очень важно! Иначе вместо символов будет абракадабра
   ...
   // Сохраненное в сессии имя уже закреплено за кем-то другим. Извиниться, отказать и попросить ввести другое имя
